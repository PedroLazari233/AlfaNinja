...
#pragma warning disable
                ...
                var backup = Selection.activeGameObject.GetComponent<LODBackup>();
                var objectMatLinks = Selection.activeGameObject.GetComponent<ObjectMaterialLinks>();

                if (backup) { backup.hideFlags = HideFlags.HideInInspector | HideFlags.HideInHierarchy; }
                if (objectMatLinks) { objectMatLinks.hideFlags = HideFlags.HideInInspector | HideFlags.HideInHierarchy; }
